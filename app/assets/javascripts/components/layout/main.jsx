      ...
      <main className={`main ${isEmpty}`} >
        ...
        <div className='main-content-scrollable'>
          <div className='main-content'>
            ...
            <TrackList currentTrack={this.props.currentTrack} nowPlaying={this.props.nowPlaying} paused={this.props.paused} auths={this.props.auths} setEmpty={this.setEmpty} username={this.props.user.username} />
          </div>
        </div>
      </main>
    )
